...
const initialState = {
    userDetails: { name: '', age: null, sleep: null, up: null, symptoms: null, lPeriod: null, diabetes: null, bmi: null, pcos: null },
  };
  ...
  const userReducer = (state = initialState, action) => {
    switch (action.type) {
      ...
      case 'PUT_USER_SYMPTOMS':
        return {
            ...state,
            userDetails: { ...state.userDetails, symptoms: action.payload.symptoms },
        };
      ...
      case 'PUT_USER_DIABETES':
        return {
            ...state,
            userDetails: { ...state.userDetails, diabetes: action.payload.diabetes },
        };
      case 'PUT_USER_BMI':
        return {
            ...state,
